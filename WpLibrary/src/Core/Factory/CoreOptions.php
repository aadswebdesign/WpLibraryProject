...
trait CoreOptions
{
    ...
    public function getSiteDataEntree($object = null, $site_data_entree)
    {
        if(!empty($object))
            $this->_site_data_entree[$object] = $site_data_entree;
        else
            $this->_site_data_entree = $site_data_entree;
        return $this;
    }
    ...
    {
        if(!empty($object))
            $this->_svg_drawing_prefix[$object];
        else
            $this->_svg_drawing_prefix;
        return $this;
    }
