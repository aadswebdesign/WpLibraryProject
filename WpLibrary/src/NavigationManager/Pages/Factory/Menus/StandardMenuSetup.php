    ...
    protected function _menu_setup($args = []){
        ...
        if ($this->_args->container) {
            ...
            if (in_array($this->_args->container, $allowed_tags)) {
                ...
                if(!empty($args->pre_element))
                    $this->_nav_menu .= $args->pre_element . '<' . $this->_args->container . $id . $role . $class . $style . $media . '>'; //todo
                else
        ...
        if ($this->_show_container){
            if(!empty($args->after_element))
                $this->_nav_menu .= '</' . $this->_args->container . '>'. $args->after_element;
            else
